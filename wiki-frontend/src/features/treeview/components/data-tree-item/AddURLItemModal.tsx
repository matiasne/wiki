...
export default function URLItemFormModal({
  node,
  open,
  onClose,
  onSave,
}: URLItemFormModalProps) {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  useEffect(() => {
    ...
    setValue("emojiUnified", "1f578-fe0f");
    setValue("type", EnumNodeType.URL);
  ...
  return (
    ...
    >
      <DialogTitle>{node ? "Edit" : "Add New URL to Crawl"}</DialogTitle>
